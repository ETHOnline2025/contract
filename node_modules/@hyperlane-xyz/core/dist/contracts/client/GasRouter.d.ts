...
export interface GasRouterInterface extends utils.Interface {
    functions: {
...
export interface GasRouter extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: GasRouterInterface;
...
//# sourceMappingURL=GasRouter.d.ts.map