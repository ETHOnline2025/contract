...
export interface HypNativeInterface extends utils.Interface {
    functions: {
...
export interface HypNative extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HypNativeInterface;
...
//# sourceMappingURL=HypNative.d.ts.map