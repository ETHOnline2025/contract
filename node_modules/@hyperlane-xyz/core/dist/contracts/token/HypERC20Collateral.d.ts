...
export interface HypERC20CollateralInterface extends utils.Interface {
    functions: {
...
export interface HypERC20Collateral extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HypERC20CollateralInterface;
...
//# sourceMappingURL=HypERC20Collateral.d.ts.map