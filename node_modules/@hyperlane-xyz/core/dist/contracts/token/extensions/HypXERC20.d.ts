...
export interface HypXERC20Interface extends utils.Interface {
    functions: {
...
export interface HypXERC20 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HypXERC20Interface;
...
//# sourceMappingURL=HypXERC20.d.ts.map