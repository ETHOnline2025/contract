...
export interface HypNativeScaledInterface extends utils.Interface {
    functions: {
    ...
    getEvent(nameOrSignatureOrTopic: "Donation(address,uint256)"): EventFragment;
...
export interface HypNativeScaled extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HypNativeScaledInterface;
    ...
    functions: {
        ...
        "transferRemote(uint32,bytes32,uint256)"(_destination: BigNumberish, _recipient: BytesLike, _amount: BigNumberish, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "transferRemote(uint32,bytes32,uint256)"(_destination: BigNumberish, _recipient: BytesLike, _amount: BigNumberish, overrides?: CallOverrides): Promise<string>;
    ...
    filters: {
        "Donation(address,uint256)"(sender?: string | null, amount?: null): DonationEventFilter;
        Donation(sender?: string | null, amount?: null): DonationEventFilter;
...
//# sourceMappingURL=HypNativeScaled.d.ts.map