...
export interface HypXERC20LockboxInterface extends utils.Interface {
    functions: {
        "approveLockbox()": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "xERC20()", values?: undefined): string;
    decodeFunctionResult(functionFragment: "approveLockbox", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "approveLockbox()", data: BytesLike): Result;
...
export interface HypXERC20Lockbox extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HypXERC20LockboxInterface;
    ...
    functions: {
        approveLockbox(overrides?: Overrides & {
            from?: string;
        ...
        "hook()"(overrides?: CallOverrides): Promise<[string]>;
        initialize(_hook: string, _ism: string, _owner: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "initialize(address,address,address)"(_hook: string, _ism: string, _owner: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    "xERC20()"(overrides?: CallOverrides): Promise<string>;
    callStatic: {
        approveLockbox(overrides?: CallOverrides): Promise<void>;
        "approveLockbox()"(overrides?: CallOverrides): Promise<void>;
        balanceOf(_account: string, overrides?: CallOverrides): Promise<BigNumber>;
        "balanceOf(address)"(_account: string, overrides?: CallOverrides): Promise<BigNumber>;
        destinationGas(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        hook(overrides?: CallOverrides): Promise<string>;
        "hook()"(overrides?: CallOverrides): Promise<string>;
        initialize(_hook: string, _ism: string, _owner: string, overrides?: CallOverrides): Promise<void>;
        "initialize(address,address,address)"(_hook: string, _ism: string, _owner: string, overrides?: CallOverrides): Promise<void>;
        interchainSecurityModule(overrides?: CallOverrides): Promise<string>;
        "interchainSecurityModule()"(overrides?: CallOverrides): Promise<string>;
        localDomain(overrides?: CallOverrides): Promise<number>;
        "localDomain()"(overrides?: CallOverrides): Promise<number>;
...
//# sourceMappingURL=HypXERC20Lockbox.d.ts.map