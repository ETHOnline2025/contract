...
export interface HypFiatTokenInterface extends utils.Interface {
    functions: {
...
export interface HypFiatToken extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HypFiatTokenInterface;
...
//# sourceMappingURL=HypFiatToken.d.ts.map