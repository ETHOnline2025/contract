...
export interface IXERC20Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "allowance" | "allowance(address,address)" | "approve" | "approve(address,uint256)" | "balanceOf" | "balanceOf(address)" | "burn" | "burn(address,uint256)" | "burningCurrentLimitOf" | "burningCurrentLimitOf(address)" | "mint" | "mint(address,uint256)" | "mintingCurrentLimitOf" | "mintingCurrentLimitOf(address)" | "owner" | "owner()" | "setLimits" | "setLimits(address,uint256,uint256)" | "totalSupply" | "totalSupply()" | "transfer" | "transfer(address,uint256)" | "transferFrom" | "transferFrom(address,address,uint256)"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "setLimits(address,uint256,uint256)", values: [string, BigNumberish, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "setLimits(address,uint256,uint256)", data: BytesLike): Result;
...
export interface IXERC20 extends BaseContract {
    ...
    functions: {
        ...
        "burn(address,uint256)"(_user: string, _amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "mint(address,uint256)"(_user: string, _amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "burn(address,uint256)"(_user: string, _amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        burningCurrentLimitOf(_bridge: string, overrides?: CallOverrides): Promise<BigNumber>;
        "burningCurrentLimitOf(address)"(_bridge: string, overrides?: CallOverrides): Promise<BigNumber>;
        mint(_user: string, _amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        "mint(address,uint256)"(_user: string, _amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        mintingCurrentLimitOf(_bridge: string, overrides?: CallOverrides): Promise<BigNumber>;
        "mintingCurrentLimitOf(address)"(_bridge: string, overrides?: CallOverrides): Promise<BigNumber>;
...
//# sourceMappingURL=IXERC20.d.ts.map