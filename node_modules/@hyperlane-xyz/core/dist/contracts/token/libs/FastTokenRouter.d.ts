...
export interface FastTokenRouterInterface extends utils.Interface {
    functions: {
...
export interface FastTokenRouter extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: FastTokenRouterInterface;
    ...
    functions: {
        ...
        "balanceOf(address)"(account: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
...
//# sourceMappingURL=FastTokenRouter.d.ts.map