...
export declare namespace MerkleLib {
    ...
    type TreeStructOutput = [string[], BigNumber] & {
        branch: string[];
        count: BigNumber;
    };
}
export interface TestMerkleTreeHookInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "count" | "count()" | "deployedBlock" | "deployedBlock()" | "hook" | "hook()" | "hookType" | "hookType()" | "insert" | "insert(bytes32)" | "interchainSecurityModule" | "interchainSecurityModule()" | "latestCheckpoint" | "latestCheckpoint()" | "localDomain" | "localDomain()" | "mailbox" | "mailbox()" | "owner" | "owner()" | "postDispatch" | "postDispatch(bytes,bytes)" | "proof" | "proof()" | "quoteDispatch" | "quoteDispatch(bytes,bytes)" | "renounceOwnership" | "renounceOwnership()" | "root" | "root()" | "setHook" | "setHook(address)" | "setInterchainSecurityModule" | "setInterchainSecurityModule(address)" | "supportsMetadata" | "supportsMetadata(bytes)" | "transferOwnership" | "transferOwnership(address)" | "tree" | "tree()"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "insert(bytes32)", values: [BytesLike]): string;
    ...
    decodeFunctionResult(functionFragment: "insert(bytes32)", data: BytesLike): Result;
    ...
    getEvent(nameOrSignatureOrTopic: "InsertedIntoTree(bytes32,uint32)"): EventFragment;
...
export type InsertedIntoTreeEventFilter = TypedEventFilter<InsertedIntoTreeEvent>;
...
export interface TestMerkleTreeHook extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestMerkleTreeHookInterface;
    ...
    functions: {
        ...
        "hookType()"(overrides?: CallOverrides): Promise<[number]>;
        insert(_id: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "insert(bytes32)"(_id: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        hookType(overrides?: CallOverrides): Promise<number>;
        "hookType()"(overrides?: CallOverrides): Promise<number>;
        insert(_id: BytesLike, overrides?: CallOverrides): Promise<void>;
        "insert(bytes32)"(_id: BytesLike, overrides?: CallOverrides): Promise<void>;
        interchainSecurityModule(overrides?: CallOverrides): Promise<string>;
        "interchainSecurityModule()"(overrides?: CallOverrides): Promise<string>;
        latestCheckpoint(overrides?: CallOverrides): Promise<[string, number]>;
        "latestCheckpoint()"(overrides?: CallOverrides): Promise<[string, number]>;
    ...
    filters: {
        ...
        "InsertedIntoTree(bytes32,uint32)"(messageId?: null, index?: null): InsertedIntoTreeEventFilter;
        InsertedIntoTree(messageId?: null, index?: null): InsertedIntoTreeEventFilter;
...
//# sourceMappingURL=TestMerkleTreeHook.d.ts.map