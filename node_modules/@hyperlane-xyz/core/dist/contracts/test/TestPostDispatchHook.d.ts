...
export interface TestPostDispatchHookInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "fee" | "fee()" | "hookType" | "hookType()" | "messageDispatched" | "messageDispatched(bytes32)" | "postDispatch" | "postDispatch(bytes,bytes)" | "quoteDispatch" | "quoteDispatch(bytes,bytes)" | "setFee" | "setFee(uint256)" | "supportsMetadata" | "supportsMetadata(bytes)"): FunctionFragment;
    encodeFunctionData(functionFragment: "fee", values?: undefined): string;
    encodeFunctionData(functionFragment: "fee()", values?: undefined): string;
    encodeFunctionData(functionFragment: "hookType", values?: undefined): string;
    encodeFunctionData(functionFragment: "hookType()", values?: undefined): string;
    encodeFunctionData(functionFragment: "messageDispatched", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "messageDispatched(bytes32)", values: [BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "setFee(uint256)", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "hookType()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "messageDispatched", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "messageDispatched(bytes32)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setFee(uint256)", data: BytesLike): Result;
...
export interface TestPostDispatchHook extends BaseContract {
    ...
    functions: {
        ...
        "hookType()"(overrides?: CallOverrides): Promise<[number]>;
        messageDispatched(messageId: BytesLike, overrides?: CallOverrides): Promise<[boolean] & {
            dispatched: boolean;
        }>;
        "messageDispatched(bytes32)"(messageId: BytesLike, overrides?: CallOverrides): Promise<[boolean] & {
            dispatched: boolean;
        }>;
        ...
        "setFee(uint256)"(_fee: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "setFee(uint256)"(_fee: BigNumberish, overrides?: CallOverrides): Promise<void>;
        supportsMetadata(arg0: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        "supportsMetadata(bytes)"(arg0: BytesLike, overrides?: CallOverrides): Promise<boolean>;
    };
    filters: {};
    estimateGas: {
        ...
        "hookType()"(overrides?: CallOverrides): Promise<BigNumber>;
        messageDispatched(messageId: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        "messageDispatched(bytes32)"(messageId: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        postDispatch(metadata: BytesLike, message: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<BigNumber>;
        "postDispatch(bytes,bytes)"(metadata: BytesLike, message: BytesLike, overrides?: PayableOverrides & {
    ...
    populateTransaction: {
        ...
        "hookType()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        messageDispatched(messageId: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "messageDispatched(bytes32)"(messageId: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        postDispatch(metadata: BytesLike, message: BytesLike, overrides?: PayableOverrides & {
            from?: string;
...
//# sourceMappingURL=TestPostDispatchHook.d.ts.map