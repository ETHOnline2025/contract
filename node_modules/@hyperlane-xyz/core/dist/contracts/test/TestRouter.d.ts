...
export interface TestRouterInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "dispatch" | "dispatch(uint32,bytes)" | "domains" | "domains()" | "enrollRemoteRouter" | "enrollRemoteRouter(uint32,bytes32)" | "enrollRemoteRouters" | "enrollRemoteRouters(uint32[],bytes32[])" | "handle" | "handle(uint32,bytes32,bytes)" | "hook" | "hook()" | "initialize" | "initialize(address,address)" | "interchainSecurityModule" | "interchainSecurityModule()" | "isRemoteRouter" | "isRemoteRouter(uint32,bytes32)" | "localDomain" | "localDomain()" | "mailbox" | "mailbox()" | "mustHaveRemoteRouter" | "mustHaveRemoteRouter(uint32)" | "owner" | "owner()" | "renounceOwnership" | "renounceOwnership()" | "routers" | "routers(uint32)" | "setHook" | "setHook(address)" | "setInterchainSecurityModule" | "setInterchainSecurityModule(address)" | "transferOwnership" | "transferOwnership(address)" | "unenrollRemoteRouter" | "unenrollRemoteRouter(uint32)" | "unenrollRemoteRouters" | "unenrollRemoteRouters(uint32[])"): FunctionFragment;
    encodeFunctionData(functionFragment: "dispatch", values: [BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "dispatch(uint32,bytes)", values: [BigNumberish, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "interchainSecurityModule()", values?: undefined): string;
    encodeFunctionData(functionFragment: "isRemoteRouter", values: [BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "isRemoteRouter(uint32,bytes32)", values: [BigNumberish, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "mailbox()", values?: undefined): string;
    encodeFunctionData(functionFragment: "mustHaveRemoteRouter", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "mustHaveRemoteRouter(uint32)", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "dispatch(uint32,bytes)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "interchainSecurityModule()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "isRemoteRouter", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "isRemoteRouter(uint32,bytes32)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "mailbox()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "mustHaveRemoteRouter", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "mustHaveRemoteRouter(uint32)", data: BytesLike): Result;
...
export type InitializeOverloadEventFilter = TypedEventFilter<InitializeOverloadEvent>;
...
export interface TestRouter extends BaseContract {
    ...
    functions: {
        dispatch(_destination: BigNumberish, _msg: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "dispatch(uint32,bytes)"(_destination: BigNumberish, _msg: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "hook()"(overrides?: CallOverrides): Promise<[string]>;
        initialize(_hook: string, _interchainSecurityModule: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "initialize(address,address)"(_hook: string, _interchainSecurityModule: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        interchainSecurityModule(overrides?: CallOverrides): Promise<[string]>;
        "interchainSecurityModule()"(overrides?: CallOverrides): Promise<[string]>;
        isRemoteRouter(_domain: BigNumberish, _potentialRemoteRouter: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;
        "isRemoteRouter(uint32,bytes32)"(_domain: BigNumberish, _potentialRemoteRouter: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;
        localDomain(overrides?: CallOverrides): Promise<[number]>;
        "localDomain()"(overrides?: CallOverrides): Promise<[number]>;
        mailbox(overrides?: CallOverrides): Promise<[string]>;
        "mailbox()"(overrides?: CallOverrides): Promise<[string]>;
        mustHaveRemoteRouter(_domain: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
        "mustHaveRemoteRouter(uint32)"(_domain: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
    ...
    callStatic: {
        dispatch(_destination: BigNumberish, _msg: BytesLike, overrides?: CallOverrides): Promise<void>;
        "dispatch(uint32,bytes)"(_destination: BigNumberish, _msg: BytesLike, overrides?: CallOverrides): Promise<void>;
        domains(overrides?: CallOverrides): Promise<number[]>;
        "domains()"(overrides?: CallOverrides): Promise<number[]>;
        ...
        hook(overrides?: CallOverrides): Promise<string>;
        "hook()"(overrides?: CallOverrides): Promise<string>;
        initialize(_hook: string, _interchainSecurityModule: string, overrides?: CallOverrides): Promise<void>;
        "initialize(address,address)"(_hook: string, _interchainSecurityModule: string, overrides?: CallOverrides): Promise<void>;
        interchainSecurityModule(overrides?: CallOverrides): Promise<string>;
        "interchainSecurityModule()"(overrides?: CallOverrides): Promise<string>;
        isRemoteRouter(_domain: BigNumberish, _potentialRemoteRouter: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        "isRemoteRouter(uint32,bytes32)"(_domain: BigNumberish, _potentialRemoteRouter: BytesLike, overrides?: CallOverrides): Promise<boolean>;
    ...
    estimateGas: {
        ...
        "interchainSecurityModule()"(overrides?: CallOverrides): Promise<BigNumber>;
        isRemoteRouter(_domain: BigNumberish, _potentialRemoteRouter: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        "isRemoteRouter(uint32,bytes32)"(_domain: BigNumberish, _potentialRemoteRouter: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        localDomain(overrides?: CallOverrides): Promise<BigNumber>;
        "localDomain()"(overrides?: CallOverrides): Promise<BigNumber>;
        mailbox(overrides?: CallOverrides): Promise<BigNumber>;
        "mailbox()"(overrides?: CallOverrides): Promise<BigNumber>;
        mustHaveRemoteRouter(_domain: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "mustHaveRemoteRouter(uint32)"(_domain: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        "interchainSecurityModule()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        isRemoteRouter(_domain: BigNumberish, _potentialRemoteRouter: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "isRemoteRouter(uint32,bytes32)"(_domain: BigNumberish, _potentialRemoteRouter: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        localDomain(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "localDomain()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        mailbox(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "mailbox()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        mustHaveRemoteRouter(_domain: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "mustHaveRemoteRouter(uint32)"(_domain: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=TestRouter.d.ts.map