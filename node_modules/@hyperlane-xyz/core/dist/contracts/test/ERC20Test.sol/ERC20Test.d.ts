...
export interface ERC20TestInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "_decimals" | "_decimals()" | "allowance" | "allowance(address,address)" | "approve" | "approve(address,uint256)" | "balanceOf" | "balanceOf(address)" | "decimals" | "decimals()" | "decreaseAllowance" | "decreaseAllowance(address,uint256)" | "increaseAllowance" | "increaseAllowance(address,uint256)" | "mint" | "mint(uint256)" | "mintTo" | "mintTo(address,uint256)" | "name" | "name()" | "symbol" | "symbol()" | "totalSupply" | "totalSupply()" | "transfer" | "transfer(address,uint256)" | "transferFrom" | "transferFrom(address,address,uint256)"): FunctionFragment;
...
export interface ERC20Test extends BaseContract {
    ...
    functions: {
        ...
        mint(amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
