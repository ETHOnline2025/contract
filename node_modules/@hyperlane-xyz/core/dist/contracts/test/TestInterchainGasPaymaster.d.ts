...
export declare namespace InterchainGasPaymaster {
    ...
    type DomainGasConfigStructOutput = [string, BigNumber] & {
        gasOracle: string;
...
export interface TestInterchainGasPaymasterInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "beneficiary" | "beneficiary()" | "claim" | "claim()" | "deployedBlock" | "deployedBlock()" | "destinationGasConfigs" | "destinationGasConfigs(uint32)" | "destinationGasLimit" | "destinationGasLimit(uint32,uint256)" | "gasPrice" | "gasPrice()" | "getDefaultGasUsage" | "getDefaultGasUsage()" | "getExchangeRateAndGasPrice" | "getExchangeRateAndGasPrice(uint32)" | "hookType" | "hookType()" | "initialize" | "initialize(address,address)" | "owner" | "owner()" | "payForGas" | "payForGas(bytes32,uint32,uint256,address)" | "postDispatch" | "postDispatch(bytes,bytes)" | "quoteDispatch" | "quoteDispatch(bytes,bytes)" | "quoteGasPayment" | "quoteGasPayment(uint32,uint256)" | "renounceOwnership" | "renounceOwnership()" | "setBeneficiary" | "setBeneficiary(address)" | "setDestinationGasConfigs" | "setDestinationGasConfigs((uint32,(address,uint96))[])" | "supportsMetadata" | "supportsMetadata(bytes)" | "transferOwnership" | "transferOwnership(address)"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "destinationGasConfigs(uint32)", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "destinationGasLimit", values: [BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "destinationGasLimit(uint32,uint256)", values: [BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "gasPrice", values?: undefined): string;
    encodeFunctionData(functionFragment: "gasPrice()", values?: undefined): string;
    encodeFunctionData(functionFragment: "getDefaultGasUsage", values?: undefined): string;
    encodeFunctionData(functionFragment: "getDefaultGasUsage()", values?: undefined): string;
    encodeFunctionData(functionFragment: "getExchangeRateAndGasPrice", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "getExchangeRateAndGasPrice(uint32)", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "payForGas(bytes32,uint32,uint256,address)", values: [BytesLike, BigNumberish, BigNumberish, string]): string;
    ...
    encodeFunctionData(functionFragment: "setBeneficiary(address)", values: [string]): string;
    encodeFunctionData(functionFragment: "setDestinationGasConfigs", values: [InterchainGasPaymaster.GasParamStruct[]]): string;
    encodeFunctionData(functionFragment: "setDestinationGasConfigs((uint32,(address,uint96))[])", values: [InterchainGasPaymaster.GasParamStruct[]]): string;
    ...
    decodeFunctionResult(functionFragment: "destinationGasConfigs(uint32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "destinationGasLimit", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "destinationGasLimit(uint32,uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "gasPrice", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "gasPrice()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getDefaultGasUsage", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getDefaultGasUsage()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getExchangeRateAndGasPrice", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getExchangeRateAndGasPrice(uint32)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "payForGas(bytes32,uint32,uint256,address)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setBeneficiary(address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setDestinationGasConfigs", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setDestinationGasConfigs((uint32,(address,uint96))[])", data: BytesLike): Result;
    ...
    getEvent(nameOrSignatureOrTopic: "DestinationGasConfigSet(uint32,address,uint96)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "GasPayment"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "GasPayment(bytes32,uint32,uint256,uint256)"): EventFragment;
...
export type DestinationGasConfigSetEventFilter = TypedEventFilter<DestinationGasConfigSetEvent>;
...
export interface TestInterchainGasPaymaster extends BaseContract {
    ...
    functions: {
        ...
        "deployedBlock()"(overrides?: CallOverrides): Promise<[BigNumber]>;
        destinationGasConfigs(arg0: BigNumberish, overrides?: CallOverrides): Promise<[
            string,
            BigNumber
        ] & {
            gasOracle: string;
        ...
        "destinationGasConfigs(uint32)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<[
            string,
            BigNumber
        ] & {
            gasOracle: string;
        ...
        destinationGasLimit(_destinationDomain: BigNumberish, _gasLimit: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
        "destinationGasLimit(uint32,uint256)"(_destinationDomain: BigNumberish, _gasLimit: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        "getExchangeRateAndGasPrice(uint32)"(_destinationDomain: BigNumberish, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber
        ] & {
            tokenExchangeRate: BigNumber;
        ...
        "initialize(address,address)"(_owner: string, _beneficiary: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        owner(overrides?: CallOverrides): Promise<[string]>;
        "owner()"(overrides?: CallOverrides): Promise<[string]>;
        payForGas(_messageId: BytesLike, _destinationDomain: BigNumberish, _gasLimit: BigNumberish, _refundAddress: string, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "payForGas(bytes32,uint32,uint256,address)"(_messageId: BytesLike, _destinationDomain: BigNumberish, _gasLimit: BigNumberish, _refundAddress: string, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "quoteGasPayment(uint32,uint256)"(arg0: BigNumberish, gasAmount: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        "setBeneficiary(address)"(_beneficiary: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setDestinationGasConfigs(_configs: InterchainGasPaymaster.GasParamStruct[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "setDestinationGasConfigs((uint32,(address,uint96))[])"(_configs: InterchainGasPaymaster.GasParamStruct[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "initialize(address,address)"(_owner: string, _beneficiary: string, overrides?: CallOverrides): Promise<void>;
        owner(overrides?: CallOverrides): Promise<string>;
        "owner()"(overrides?: CallOverrides): Promise<string>;
        payForGas(_messageId: BytesLike, _destinationDomain: BigNumberish, _gasLimit: BigNumberish, _refundAddress: string, overrides?: CallOverrides): Promise<void>;
        "payForGas(bytes32,uint32,uint256,address)"(_messageId: BytesLike, _destinationDomain: BigNumberish, _gasLimit: BigNumberish, _refundAddress: string, overrides?: CallOverrides): Promise<void>;
        ...
        "setBeneficiary(address)"(_beneficiary: string, overrides?: CallOverrides): Promise<void>;
        setDestinationGasConfigs(_configs: InterchainGasPaymaster.GasParamStruct[], overrides?: CallOverrides): Promise<void>;
        "setDestinationGasConfigs((uint32,(address,uint96))[])"(_configs: InterchainGasPaymaster.GasParamStruct[], overrides?: CallOverrides): Promise<void>;
        supportsMetadata(metadata: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        "supportsMetadata(bytes)"(metadata: BytesLike, overrides?: CallOverrides): Promise<boolean>;
    ...
    filters: {
        ...
        "DestinationGasConfigSet(uint32,address,uint96)"(remoteDomain?: null, gasOracle?: null, gasOverhead?: null): DestinationGasConfigSetEventFilter;
        DestinationGasConfigSet(remoteDomain?: null, gasOracle?: null, gasOverhead?: null): DestinationGasConfigSetEventFilter;
        "GasPayment(bytes32,uint32,uint256,uint256)"(messageId?: BytesLike | null, destinationDomain?: BigNumberish | null, gasAmount?: null, payment?: null): GasPaymentEventFilter;
        GasPayment(messageId?: BytesLike | null, destinationDomain?: BigNumberish | null, gasAmount?: null, payment?: null): GasPaymentEventFilter;
    ...
    estimateGas: {
        ...
        deployedBlock(overrides?: CallOverrides): Promise<BigNumber>;
        "deployedBlock()"(overrides?: CallOverrides): Promise<BigNumber>;
        destinationGasConfigs(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "destinationGasConfigs(uint32)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        destinationGasLimit(_destinationDomain: BigNumberish, _gasLimit: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "destinationGasLimit(uint32,uint256)"(_destinationDomain: BigNumberish, _gasLimit: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        gasPrice(overrides?: CallOverrides): Promise<BigNumber>;
        "gasPrice()"(overrides?: CallOverrides): Promise<BigNumber>;
        ...
        "getExchangeRateAndGasPrice(uint32)"(_destinationDomain: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        "deployedBlock()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        destinationGasConfigs(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "destinationGasConfigs(uint32)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        destinationGasLimit(_destinationDomain: BigNumberish, _gasLimit: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "destinationGasLimit(uint32,uint256)"(_destinationDomain: BigNumberish, _gasLimit: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        gasPrice(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "gasPrice()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getDefaultGasUsage(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "getDefaultGasUsage()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getExchangeRateAndGasPrice(_destinationDomain: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "getExchangeRateAndGasPrice(uint32)"(_destinationDomain: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        "quoteGasPayment(uint32,uint256)"(arg0: BigNumberish, gasAmount: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        renounceOwnership(overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        "renounceOwnership()"(overrides?: Overrides & {
