...
export interface IDelegationManagerInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getOperatorShares" | "getOperatorShares(address,address[])" | "registerAsOperator" | "registerAsOperator((address,address,uint32),string)"): FunctionFragment;
...
//# sourceMappingURL=IDelegationManager.d.ts.map