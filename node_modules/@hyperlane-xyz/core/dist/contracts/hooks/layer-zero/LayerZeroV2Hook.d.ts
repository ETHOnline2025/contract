...
export type LayerZeroV2MetadataStruct = {
    eid: BigNumberish;
    refundAddress: string;
    options: BytesLike;
};
export type LayerZeroV2MetadataStructOutput = [number, string, string] & {
    eid: number;
    refundAddress: string;
    options: string;
};
export interface LayerZeroV2HookInterface extends utils.Interface {
    functions: {
        "destinationDomain()": FunctionFragment;
        "formatLzMetadata((uint32,address,bytes))": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "destinationDomain" | "destinationDomain()" | "formatLzMetadata" | "formatLzMetadata((uint32,address,bytes))" | "hook" | "hook()" | "hookType" | "hookType()" | "interchainSecurityModule" | "interchainSecurityModule()" | "ism" | "ism()" | "lZEndpoint" | "lZEndpoint()" | "localDomain" | "localDomain()" | "mailbox" | "mailbox()" | "owner" | "owner()" | "parseLzMetadata" | "parseLzMetadata(bytes)" | "postDispatch" | "postDispatch(bytes,bytes)" | "quoteDispatch" | "quoteDispatch(bytes,bytes)" | "renounceOwnership" | "renounceOwnership()" | "setHook" | "setHook(address)" | "setInterchainSecurityModule" | "setInterchainSecurityModule(address)" | "supportsMetadata" | "supportsMetadata(bytes)" | "transferOwnership" | "transferOwnership(address)"): FunctionFragment;
    encodeFunctionData(functionFragment: "destinationDomain", values?: undefined): string;
    encodeFunctionData(functionFragment: "destinationDomain()", values?: undefined): string;
    encodeFunctionData(functionFragment: "formatLzMetadata", values: [LayerZeroV2MetadataStruct]): string;
    encodeFunctionData(functionFragment: "formatLzMetadata((uint32,address,bytes))", values: [LayerZeroV2MetadataStruct]): string;
    ...
    decodeFunctionResult(functionFragment: "formatLzMetadata((uint32,address,bytes))", data: BytesLike): Result;
...
export interface LayerZeroV2Hook extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: LayerZeroV2HookInterface;
    ...
    functions: {
        ...
        "destinationDomain()"(overrides?: CallOverrides): Promise<[number]>;
        formatLzMetadata(layerZeroMetadata: LayerZeroV2MetadataStruct, overrides?: CallOverrides): Promise<[string]>;
        "formatLzMetadata((uint32,address,bytes))"(layerZeroMetadata: LayerZeroV2MetadataStruct, overrides?: CallOverrides): Promise<[string]>;
    ...
    estimateGas: {
        ...
        "destinationDomain()"(overrides?: CallOverrides): Promise<BigNumber>;
        formatLzMetadata(layerZeroMetadata: LayerZeroV2MetadataStruct, overrides?: CallOverrides): Promise<BigNumber>;
        "formatLzMetadata((uint32,address,bytes))"(layerZeroMetadata: LayerZeroV2MetadataStruct, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        "destinationDomain()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        formatLzMetadata(layerZeroMetadata: LayerZeroV2MetadataStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "formatLzMetadata((uint32,address,bytes))"(layerZeroMetadata: LayerZeroV2MetadataStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=LayerZeroV2Hook.d.ts.map