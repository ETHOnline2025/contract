...
export type LayerZeroMetadataStruct = {
...
export type LayerZeroMetadataStructOutput = [
    number,
    string,
    string,
    string,
...
export interface LayerZeroV1HookInterface extends utils.Interface {
    functions: {
        "formatLzMetadata((uint16,address,address,bytes,bytes,bytes))": FunctionFragment;
        ...
        "parseLzMetadata(bytes)": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "formatLzMetadata" | "formatLzMetadata((uint16,address,address,bytes,bytes,bytes))" | "hook" | "hook()" | "hookType" | "hookType()" | "interchainSecurityModule" | "interchainSecurityModule()" | "lZEndpoint" | "lZEndpoint()" | "localDomain" | "localDomain()" | "mailbox" | "mailbox()" | "owner" | "owner()" | "parseLzMetadata" | "parseLzMetadata(bytes)" | "postDispatch" | "postDispatch(bytes,bytes)" | "quoteDispatch" | "quoteDispatch(bytes,bytes)" | "renounceOwnership" | "renounceOwnership()" | "setHook" | "setHook(address)" | "setInterchainSecurityModule" | "setInterchainSecurityModule(address)" | "supportsMetadata" | "supportsMetadata(bytes)" | "transferOwnership" | "transferOwnership(address)"): FunctionFragment;
    encodeFunctionData(functionFragment: "formatLzMetadata", values: [LayerZeroMetadataStruct]): string;
    encodeFunctionData(functionFragment: "formatLzMetadata((uint16,address,address,bytes,bytes,bytes))", values: [LayerZeroMetadataStruct]): string;
    ...
    encodeFunctionData(functionFragment: "owner()", values?: undefined): string;
    encodeFunctionData(functionFragment: "parseLzMetadata", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "parseLzMetadata(bytes)", values: [BytesLike]): string;
    ...
    decodeFunctionResult(functionFragment: "formatLzMetadata", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "formatLzMetadata((uint16,address,address,bytes,bytes,bytes))", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "owner()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "parseLzMetadata", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "parseLzMetadata(bytes)", data: BytesLike): Result;
...
export interface LayerZeroV1Hook extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: LayerZeroV1HookInterface;
    ...
    functions: {
        formatLzMetadata(layerZeroMetadata: LayerZeroMetadataStruct, overrides?: CallOverrides): Promise<[string]>;
        "formatLzMetadata((uint16,address,address,bytes,bytes,bytes))"(layerZeroMetadata: LayerZeroMetadataStruct, overrides?: CallOverrides): Promise<[string]>;
        ...
        "owner()"(overrides?: CallOverrides): Promise<[string]>;
        parseLzMetadata(lZMetadata: BytesLike, overrides?: CallOverrides): Promise<[
            LayerZeroMetadataStructOutput
        ] & {
            parsedLayerZeroMetadata: LayerZeroMetadataStructOutput;
        }>;
        "parseLzMetadata(bytes)"(lZMetadata: BytesLike, overrides?: CallOverrides): Promise<[
            LayerZeroMetadataStructOutput
        ] & {
            parsedLayerZeroMetadata: LayerZeroMetadataStructOutput;
        }>;
    ...
    owner(overrides?: CallOverrides): Promise<string>;
    "owner()"(overrides?: CallOverrides): Promise<string>;
    parseLzMetadata(lZMetadata: BytesLike, overrides?: CallOverrides): Promise<LayerZeroMetadataStructOutput>;
    "parseLzMetadata(bytes)"(lZMetadata: BytesLike, overrides?: CallOverrides): Promise<LayerZeroMetadataStructOutput>;
    postDispatch(metadata: BytesLike, message: BytesLike, overrides?: PayableOverrides & {
        from?: string;
    }): Promise<ContractTransaction>;
    "postDispatch(bytes,bytes)"(metadata: BytesLike, message: BytesLike, overrides?: PayableOverrides & {
    ...
    estimateGas: {
        formatLzMetadata(layerZeroMetadata: LayerZeroMetadataStruct, overrides?: CallOverrides): Promise<BigNumber>;
        "formatLzMetadata((uint16,address,address,bytes,bytes,bytes))"(layerZeroMetadata: LayerZeroMetadataStruct, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        "owner()"(overrides?: CallOverrides): Promise<BigNumber>;
        parseLzMetadata(lZMetadata: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        "parseLzMetadata(bytes)"(lZMetadata: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        postDispatch(metadata: BytesLike, message: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<BigNumber>;
        "postDispatch(bytes,bytes)"(metadata: BytesLike, message: BytesLike, overrides?: PayableOverrides & {
    ...
    populateTransaction: {
        formatLzMetadata(layerZeroMetadata: LayerZeroMetadataStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "formatLzMetadata((uint16,address,address,bytes,bytes,bytes))"(layerZeroMetadata: LayerZeroMetadataStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        "owner()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        parseLzMetadata(lZMetadata: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "parseLzMetadata(bytes)"(lZMetadata: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        postDispatch(metadata: BytesLike, message: BytesLike, overrides?: PayableOverrides & {
            from?: string;
...
//# sourceMappingURL=LayerZeroV1Hook.d.ts.map