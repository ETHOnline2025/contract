...
export interface PausableHookInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "hookType" | "hookType()" | "owner" | "owner()" | "pause" | "pause()" | "paused" | "paused()" | "postDispatch" | "postDispatch(bytes,bytes)" | "quoteDispatch" | "quoteDispatch(bytes,bytes)" | "renounceOwnership" | "renounceOwnership()" | "supportsMetadata" | "supportsMetadata(bytes)" | "transferOwnership" | "transferOwnership(address)" | "unpause" | "unpause()"): FunctionFragment;
...
//# sourceMappingURL=PausableHook.d.ts.map