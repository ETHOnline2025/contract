...
export interface StaticAggregationHookInterface extends utils.Interface {
    functions: {
        "hookType()": FunctionFragment;
        "hooks(bytes)": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "hookType" | "hookType()" | "hooks" | "hooks(bytes)" | "postDispatch" | "postDispatch(bytes,bytes)" | "quoteDispatch" | "quoteDispatch(bytes,bytes)" | "supportsMetadata" | "supportsMetadata(bytes)"): FunctionFragment;
    encodeFunctionData(functionFragment: "hookType", values?: undefined): string;
    encodeFunctionData(functionFragment: "hookType()", values?: undefined): string;
    encodeFunctionData(functionFragment: "hooks", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "hooks(bytes)", values: [BytesLike]): string;
    ...
    decodeFunctionResult(functionFragment: "hooks(bytes)", data: BytesLike): Result;
...
export interface StaticAggregationHook extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: StaticAggregationHookInterface;
    ...
    functions: {
        ...
        "hookType()"(overrides?: CallOverrides): Promise<[number]>;
        hooks(arg0: BytesLike, overrides?: CallOverrides): Promise<[string[]]>;
        "hooks(bytes)"(arg0: BytesLike, overrides?: CallOverrides): Promise<[string[]]>;
    ...
    estimateGas: {
        ...
        "hookType()"(overrides?: CallOverrides): Promise<BigNumber>;
        hooks(arg0: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        "hooks(bytes)"(arg0: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        postDispatch(metadata: BytesLike, message: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<BigNumber>;
        "postDispatch(bytes,bytes)"(metadata: BytesLike, message: BytesLike, overrides?: PayableOverrides & {
    ...
    populateTransaction: {
        ...
        "hookType()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        hooks(arg0: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "hooks(bytes)"(arg0: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        postDispatch(metadata: BytesLike, message: BytesLike, overrides?: PayableOverrides & {
            from?: string;
...
//# sourceMappingURL=StaticAggregationHook.d.ts.map