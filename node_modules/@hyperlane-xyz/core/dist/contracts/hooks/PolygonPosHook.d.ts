...
export interface PolygonPosHookInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "SEND_MESSAGE_EVENT_SIG" | "SEND_MESSAGE_EVENT_SIG()" | "checkpointManager" | "checkpointManager()" | "destinationDomain" | "destinationDomain()" | "fxChildTunnel" | "fxChildTunnel()" | "fxRoot" | "fxRoot()" | "hook" | "hook()" | "hookType" | "hookType()" | "interchainSecurityModule" | "interchainSecurityModule()" | "ism" | "ism()" | "latestData" | "latestData()" | "localDomain" | "localDomain()" | "mailbox" | "mailbox()" | "owner" | "owner()" | "postDispatch" | "postDispatch(bytes,bytes)" | "processedExits" | "processedExits(bytes32)" | "quoteDispatch" | "quoteDispatch(bytes,bytes)" | "receiveMessage" | "receiveMessage(bytes)" | "renounceOwnership" | "renounceOwnership()" | "setFxChildTunnel" | "setFxChildTunnel(address)" | "setHook" | "setHook(address)" | "setInterchainSecurityModule" | "setInterchainSecurityModule(address)" | "supportsMetadata" | "supportsMetadata(bytes)" | "transferOwnership" | "transferOwnership(address)"): FunctionFragment;
    encodeFunctionData(functionFragment: "SEND_MESSAGE_EVENT_SIG", values?: undefined): string;
    encodeFunctionData(functionFragment: "SEND_MESSAGE_EVENT_SIG()", values?: undefined): string;
    encodeFunctionData(functionFragment: "checkpointManager", values?: undefined): string;
    encodeFunctionData(functionFragment: "checkpointManager()", values?: undefined): string;
    encodeFunctionData(functionFragment: "destinationDomain", values?: undefined): string;
    encodeFunctionData(functionFragment: "destinationDomain()", values?: undefined): string;
    encodeFunctionData(functionFragment: "fxChildTunnel", values?: undefined): string;
    encodeFunctionData(functionFragment: "fxChildTunnel()", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "ism()", values?: undefined): string;
    encodeFunctionData(functionFragment: "latestData", values?: undefined): string;
    encodeFunctionData(functionFragment: "latestData()", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "processedExits(bytes32)", values: [BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "receiveMessage(bytes)", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "renounceOwnership", values?: undefined): string;
    encodeFunctionData(functionFragment: "renounceOwnership()", values?: undefined): string;
    encodeFunctionData(functionFragment: "setFxChildTunnel", values: [string]): string;
    encodeFunctionData(functionFragment: "setFxChildTunnel(address)", values: [string]): string;
    ...
    decodeFunctionResult(functionFragment: "SEND_MESSAGE_EVENT_SIG", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "SEND_MESSAGE_EVENT_SIG()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "checkpointManager", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "checkpointManager()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "destinationDomain", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "destinationDomain()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "fxChildTunnel", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "fxChildTunnel()", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "processedExits(bytes32)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "receiveMessage(bytes)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "renounceOwnership", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "renounceOwnership()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setFxChildTunnel", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setFxChildTunnel(address)", data: BytesLike): Result;
...
export interface PolygonPosHook extends BaseContract {
    ...
    functions: {
        ...
        "processedExits(bytes32)"(arg0: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;
        ...
        receiveMessage(inputData: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "receiveMessage(bytes)"(inputData: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        setFxChildTunnel(_fxChildTunnel: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "setFxChildTunnel(address)"(_fxChildTunnel: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        quoteDispatch(metadata: BytesLike, message: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        "quoteDispatch(bytes,bytes)"(metadata: BytesLike, message: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        receiveMessage(inputData: BytesLike, overrides?: CallOverrides): Promise<void>;
        "receiveMessage(bytes)"(inputData: BytesLike, overrides?: CallOverrides): Promise<void>;
        renounceOwnership(overrides?: CallOverrides): Promise<void>;
        "renounceOwnership()"(overrides?: CallOverrides): Promise<void>;
        setFxChildTunnel(_fxChildTunnel: string, overrides?: CallOverrides): Promise<void>;
        "setFxChildTunnel(address)"(_fxChildTunnel: string, overrides?: CallOverrides): Promise<void>;
    ...
    estimateGas: {
        ...
        processedExits(arg0: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        "processedExits(bytes32)"(arg0: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        quoteDispatch(metadata: BytesLike, message: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        "quoteDispatch(bytes,bytes)"(metadata: BytesLike, message: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        receiveMessage(inputData: BytesLike, overrides?: Overrides & {
            from?: string;
    ...
    populateTransaction: {
        ...
        processedExits(arg0: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "processedExits(bytes32)"(arg0: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=PolygonPosHook.d.ts.map