...
export interface FallbackDomainRoutingHookInterface extends utils.Interface {
    functions: {
        "fallbackHook()": FunctionFragment;
    ...
    decodeFunctionResult(functionFragment: "fallbackHook", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "fallbackHook()", data: BytesLike): Result;
...
export interface FallbackDomainRoutingHook extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: FallbackDomainRoutingHookInterface;
    ...
    functions: {
        fallbackHook(overrides?: CallOverrides): Promise<[string]>;
        "fallbackHook()"(overrides?: CallOverrides): Promise<[string]>;
    ...
    estimateGas: {
        fallbackHook(overrides?: CallOverrides): Promise<BigNumber>;
        "fallbackHook()"(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        fallbackHook(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "fallbackHook()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=FallbackDomainRoutingHook.d.ts.map