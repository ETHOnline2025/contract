...
export interface DomainRoutingHookInterface extends utils.Interface {
    functions: {
...
export interface DomainRoutingHook extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: DomainRoutingHookInterface;
...
//# sourceMappingURL=DomainRoutingHook.d.ts.map