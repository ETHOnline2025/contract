...
export interface AbstractMessageIdAuthHookInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "destinationDomain" | "destinationDomain()" | "hook" | "hook()" | "hookType" | "hookType()" | "interchainSecurityModule" | "interchainSecurityModule()" | "ism" | "ism()" | "localDomain" | "localDomain()" | "mailbox" | "mailbox()" | "owner" | "owner()" | "postDispatch" | "postDispatch(bytes,bytes)" | "quoteDispatch" | "quoteDispatch(bytes,bytes)" | "renounceOwnership" | "renounceOwnership()" | "setHook" | "setHook(address)" | "setInterchainSecurityModule" | "setInterchainSecurityModule(address)" | "supportsMetadata" | "supportsMetadata(bytes)" | "transferOwnership" | "transferOwnership(address)"): FunctionFragment;
...
export interface AbstractMessageIdAuthHook extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AbstractMessageIdAuthHookInterface;
...
//# sourceMappingURL=AbstractMessageIdAuthHook.d.ts.map