...
export interface ProtocolFeeInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "MAX_PROTOCOL_FEE" | "MAX_PROTOCOL_FEE()" | "beneficiary" | "beneficiary()" | "collectProtocolFees" | "collectProtocolFees()" | "hookType" | "hookType()" | "owner" | "owner()" | "postDispatch" | "postDispatch(bytes,bytes)" | "protocolFee" | "protocolFee()" | "quoteDispatch" | "quoteDispatch(bytes,bytes)" | "renounceOwnership" | "renounceOwnership()" | "setBeneficiary" | "setBeneficiary(address)" | "setProtocolFee" | "setProtocolFee(uint256)" | "supportsMetadata" | "supportsMetadata(bytes)" | "transferOwnership" | "transferOwnership(address)"): FunctionFragment;
    encodeFunctionData(functionFragment: "MAX_PROTOCOL_FEE", values?: undefined): string;
    encodeFunctionData(functionFragment: "MAX_PROTOCOL_FEE()", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "setProtocolFee(uint256)", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "MAX_PROTOCOL_FEE", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "MAX_PROTOCOL_FEE()", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setProtocolFee(uint256)", data: BytesLike): Result;
...
export interface ProtocolFee extends BaseContract {
    ...
    functions: {
        ...
        "beneficiary()"(overrides?: CallOverrides): Promise<[string]>;
        collectProtocolFees(overrides?: Overrides & {
            from?: string;
        ...
        setProtocolFee(_protocolFee: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "setProtocolFee(uint256)"(_protocolFee: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "setProtocolFee(uint256)"(_protocolFee: BigNumberish, overrides?: CallOverrides): Promise<void>;
        supportsMetadata(metadata: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        "supportsMetadata(bytes)"(metadata: BytesLike, overrides?: CallOverrides): Promise<boolean>;
