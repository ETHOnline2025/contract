...
export interface StorageGasOracleInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getExchangeRateAndGasPrice" | "getExchangeRateAndGasPrice(uint32)" | "owner" | "owner()" | "remoteGasData" | "remoteGasData(uint32)" | "renounceOwnership" | "renounceOwnership()" | "setRemoteGasData" | "setRemoteGasData((uint32,uint128,uint128))" | "setRemoteGasDataConfigs" | "setRemoteGasDataConfigs((uint32,uint128,uint128)[])" | "transferOwnership" | "transferOwnership(address)"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "remoteGasData(uint32)", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "setRemoteGasData((uint32,uint128,uint128))", values: [StorageGasOracle.RemoteGasDataConfigStruct]): string;
    encodeFunctionData(functionFragment: "setRemoteGasDataConfigs", values: [StorageGasOracle.RemoteGasDataConfigStruct[]]): string;
    encodeFunctionData(functionFragment: "setRemoteGasDataConfigs((uint32,uint128,uint128)[])", values: [StorageGasOracle.RemoteGasDataConfigStruct[]]): string;
    ...
    decodeFunctionResult(functionFragment: "remoteGasData(uint32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "renounceOwnership", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "renounceOwnership()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setRemoteGasData", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setRemoteGasData((uint32,uint128,uint128))", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setRemoteGasDataConfigs", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setRemoteGasDataConfigs((uint32,uint128,uint128)[])", data: BytesLike): Result;
    ...
    getEvent(nameOrSignatureOrTopic: "RemoteGasDataSet(uint32,uint128,uint128)"): EventFragment;
}
...
export type RemoteGasDataSetEventFilter = TypedEventFilter<RemoteGasDataSetEvent>;
export interface StorageGasOracle extends BaseContract {
    ...
    functions: {
        ...
        "remoteGasData(uint32)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber
        ] & {
            tokenExchangeRate: BigNumber;
        ...
        "setRemoteGasData((uint32,uint128,uint128))"(_config: StorageGasOracle.RemoteGasDataConfigStruct, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setRemoteGasDataConfigs(_configs: StorageGasOracle.RemoteGasDataConfigStruct[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "setRemoteGasDataConfigs((uint32,uint128,uint128)[])"(_configs: StorageGasOracle.RemoteGasDataConfigStruct[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "setRemoteGasData((uint32,uint128,uint128))"(_config: StorageGasOracle.RemoteGasDataConfigStruct, overrides?: CallOverrides): Promise<void>;
        setRemoteGasDataConfigs(_configs: StorageGasOracle.RemoteGasDataConfigStruct[], overrides?: CallOverrides): Promise<void>;
        "setRemoteGasDataConfigs((uint32,uint128,uint128)[])"(_configs: StorageGasOracle.RemoteGasDataConfigStruct[], overrides?: CallOverrides): Promise<void>;
    ...
    estimateGas: {
        ...
        "remoteGasData(uint32)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        renounceOwnership(overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        "renounceOwnership()"(overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        "remoteGasData(uint32)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        renounceOwnership(overrides?: Overrides & {
            from?: string;
