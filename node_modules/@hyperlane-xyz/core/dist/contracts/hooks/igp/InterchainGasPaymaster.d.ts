...
export interface InterchainGasPaymaster extends BaseContract {
    ...
    functions: {
        ...
        quoteGasPayment(_destinationDomain: BigNumberish, _gasLimit: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
        "quoteGasPayment(uint32,uint256)"(_destinationDomain: BigNumberish, _gasLimit: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    populateTransaction: {
        ...
        quoteGasPayment(_destinationDomain: BigNumberish, _gasLimit: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "quoteGasPayment(uint32,uint256)"(_destinationDomain: BigNumberish, _gasLimit: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        renounceOwnership(overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        "renounceOwnership()"(overrides?: Overrides & {
