...
export interface MerkleTreeHookInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "count" | "count()" | "deployedBlock" | "deployedBlock()" | "hook" | "hook()" | "hookType" | "hookType()" | "interchainSecurityModule" | "interchainSecurityModule()" | "latestCheckpoint" | "latestCheckpoint()" | "localDomain" | "localDomain()" | "mailbox" | "mailbox()" | "owner" | "owner()" | "postDispatch" | "postDispatch(bytes,bytes)" | "quoteDispatch" | "quoteDispatch(bytes,bytes)" | "renounceOwnership" | "renounceOwnership()" | "root" | "root()" | "setHook" | "setHook(address)" | "setInterchainSecurityModule" | "setInterchainSecurityModule(address)" | "supportsMetadata" | "supportsMetadata(bytes)" | "transferOwnership" | "transferOwnership(address)" | "tree" | "tree()"): FunctionFragment;
...
//# sourceMappingURL=MerkleTreeHook.d.ts.map