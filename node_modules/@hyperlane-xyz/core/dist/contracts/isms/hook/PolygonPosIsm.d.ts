...
export interface PolygonPosIsmInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "VERIFIED_MASK_INDEX" | "VERIFIED_MASK_INDEX()" | "authorizedHook" | "authorizedHook()" | "moduleType" | "moduleType()" | "processMessageFromRoot" | "processMessageFromRoot(uint256,address,bytes)" | "setAuthorizedHook" | "setAuthorizedHook(bytes32)" | "verifiedMessages" | "verifiedMessages(bytes32)" | "verify" | "verify(bytes,bytes)" | "verifyMessageId" | "verifyMessageId(bytes32)"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "processMessageFromRoot(uint256,address,bytes)", values: [BigNumberish, string, BytesLike]): string;
    ...
    decodeFunctionResult(functionFragment: "processMessageFromRoot(uint256,address,bytes)", data: BytesLike): Result;
...
export interface PolygonPosIsm extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: PolygonPosIsmInterface;
    ...
    functions: {
        ...
        "moduleType()"(overrides?: CallOverrides): Promise<[number]>;
        processMessageFromRoot(arg0: BigNumberish, rootMessageSender: string, data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "processMessageFromRoot(uint256,address,bytes)"(arg0: BigNumberish, rootMessageSender: string, data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        moduleType(overrides?: CallOverrides): Promise<number>;
        "moduleType()"(overrides?: CallOverrides): Promise<number>;
        processMessageFromRoot(arg0: BigNumberish, rootMessageSender: string, data: BytesLike, overrides?: CallOverrides): Promise<void>;
        "processMessageFromRoot(uint256,address,bytes)"(arg0: BigNumberish, rootMessageSender: string, data: BytesLike, overrides?: CallOverrides): Promise<void>;
...
//# sourceMappingURL=PolygonPosIsm.d.ts.map