...
export interface OPStackIsmInterface extends utils.Interface {
    functions: {
...
export interface OPStackIsm extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: OPStackIsmInterface;
...
//# sourceMappingURL=OPStackIsm.d.ts.map