...
export interface AbstractMessageIdAuthorizedIsmInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "VERIFIED_MASK_INDEX" | "VERIFIED_MASK_INDEX()" | "authorizedHook" | "authorizedHook()" | "moduleType" | "moduleType()" | "setAuthorizedHook" | "setAuthorizedHook(bytes32)" | "verifiedMessages" | "verifiedMessages(bytes32)" | "verify" | "verify(bytes,bytes)" | "verifyMessageId" | "verifyMessageId(bytes32)"): FunctionFragment;
...
export interface AbstractMessageIdAuthorizedIsm extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AbstractMessageIdAuthorizedIsmInterface;
...
//# sourceMappingURL=AbstractMessageIdAuthorizedIsm.d.ts.map