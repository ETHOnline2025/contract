...
export interface ERC5164IsmInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "VERIFIED_MASK_INDEX" | "VERIFIED_MASK_INDEX()" | "authorizedHook" | "authorizedHook()" | "executor" | "executor()" | "moduleType" | "moduleType()" | "setAuthorizedHook" | "setAuthorizedHook(bytes32)" | "verifiedMessages" | "verifiedMessages(bytes32)" | "verify" | "verify(bytes,bytes)" | "verifyMessageId" | "verifyMessageId(bytes32)"): FunctionFragment;
...
export interface ERC5164Ism extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC5164IsmInterface;
...
//# sourceMappingURL=ERC5164Ism.d.ts.map