...
export interface InterchainAccountIsmInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "moduleType" | "moduleType()" | "route" | "route(bytes)" | "verify" | "verify(bytes,bytes)"): FunctionFragment;
...
//# sourceMappingURL=InterchainAccountIsm.d.ts.map