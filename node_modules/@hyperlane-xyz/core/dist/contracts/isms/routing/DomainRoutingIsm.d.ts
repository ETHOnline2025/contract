...
export interface DomainRoutingIsmInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "domains" | "domains()" | "initialize(address,uint32[],address[])" | "initialize(address)" | "module" | "module(uint32)" | "moduleType" | "moduleType()" | "owner" | "owner()" | "remove" | "remove(uint32)" | "renounceOwnership" | "renounceOwnership()" | "route" | "route(bytes)" | "set" | "set(uint32,address)" | "transferOwnership" | "transferOwnership(address)" | "verify" | "verify(bytes,bytes)"): FunctionFragment;
