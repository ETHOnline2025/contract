...
export interface AbstractMetaProxyMultisigIsmInterface extends utils.Interface {
    functions: {
...
export interface AbstractMetaProxyMultisigIsm extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AbstractMetaProxyMultisigIsmInterface;
...
//# sourceMappingURL=AbstractMetaProxyMultisigIsm.d.ts.map