...
export interface StaticMerkleRootMultisigIsmInterface extends utils.Interface {
    functions: {
...
export interface StaticMerkleRootMultisigIsm extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: StaticMerkleRootMultisigIsmInterface;
...
//# sourceMappingURL=StaticMerkleRootMultisigIsm.d.ts.map