...
export interface AbstractMerkleRootMultisigIsmInterface extends utils.Interface {
    functions: {
        "moduleType()": FunctionFragment;
        "validatorsAndThreshold(bytes)": FunctionFragment;
        "verify(bytes,bytes)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "moduleType" | "moduleType()" | "validatorsAndThreshold" | "validatorsAndThreshold(bytes)" | "verify" | "verify(bytes,bytes)"): FunctionFragment;
...
export interface AbstractMerkleRootMultisigIsm extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AbstractMerkleRootMultisigIsmInterface;
    ...
    functions: {
        ...
        "validatorsAndThreshold(bytes)"(_message: BytesLike, overrides?: CallOverrides): Promise<[string[], number]>;
    ...
    estimateGas: {
        ...
        "validatorsAndThreshold(bytes)"(_message: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        verify(_metadata: BytesLike, _message: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        "verify(bytes,bytes)"(_metadata: BytesLike, _message: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        ...
        "validatorsAndThreshold(bytes)"(_message: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        verify(_metadata: BytesLike, _message: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "verify(bytes,bytes)"(_metadata: BytesLike, _message: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
//# sourceMappingURL=AbstractMerkleRootMultisigIsm.d.ts.map