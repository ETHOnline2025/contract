...
export interface AbstractMultisigIsmInterface extends utils.Interface {
    functions: {
...
export interface AbstractMultisigIsm extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AbstractMultisigIsmInterface;
...
//# sourceMappingURL=AbstractMultisigIsm.d.ts.map