...
export interface PausableIsmInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "moduleType" | "moduleType()" | "owner" | "owner()" | "pause" | "pause()" | "paused" | "paused()" | "renounceOwnership" | "renounceOwnership()" | "transferOwnership" | "transferOwnership(address)" | "unpause" | "unpause()" | "verify" | "verify(bytes,bytes)"): FunctionFragment;
