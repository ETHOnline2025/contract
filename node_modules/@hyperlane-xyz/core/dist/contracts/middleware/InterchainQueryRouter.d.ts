...
export interface InterchainQueryRouterInterface extends utils.Interface {
    ...
    getEvent(nameOrSignatureOrTopic: "QueryDispatched(uint32,address)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "QueryExecuted"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "QueryExecuted(uint32,bytes32)"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "QueryResolved"): EventFragment;
    getEvent(nameOrSignatureOrTopic: "QueryResolved(uint32,address)"): EventFragment;
}
...
export interface InterchainQueryRouter extends BaseContract {
    ...
    filters: {
        ...
        "QueryDispatched(uint32,address)"(destination?: BigNumberish | null, sender?: string | null): QueryDispatchedEventFilter;
        QueryDispatched(destination?: BigNumberish | null, sender?: string | null): QueryDispatchedEventFilter;
        "QueryExecuted(uint32,bytes32)"(originDomain?: BigNumberish | null, sender?: BytesLike | null): QueryExecutedEventFilter;
        QueryExecuted(originDomain?: BigNumberish | null, sender?: BytesLike | null): QueryExecutedEventFilter;
        "QueryResolved(uint32,address)"(destination?: BigNumberish | null, sender?: string | null): QueryResolvedEventFilter;
        QueryResolved(destination?: BigNumberish | null, sender?: string | null): QueryResolvedEventFilter;
    };
    estimateGas: {
...
//# sourceMappingURL=InterchainQueryRouter.d.ts.map