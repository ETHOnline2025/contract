...
export interface LiquidityLayerRouterInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "dispatchWithTokens" | "dispatchWithTokens(uint32,bytes32,address,uint256,string,bytes)" | "domains" | "domains()" | "enrollRemoteRouter" | "enrollRemoteRouter(uint32,bytes32)" | "enrollRemoteRouters" | "enrollRemoteRouters(uint32[],bytes32[])" | "handle" | "handle(uint32,bytes32,bytes)" | "hook" | "hook()" | "initialize" | "initialize(address,address,address)" | "interchainSecurityModule" | "interchainSecurityModule()" | "liquidityLayerAdapters" | "liquidityLayerAdapters(string)" | "localDomain" | "localDomain()" | "mailbox" | "mailbox()" | "owner" | "owner()" | "renounceOwnership" | "renounceOwnership()" | "routers" | "routers(uint32)" | "setHook" | "setHook(address)" | "setInterchainSecurityModule" | "setInterchainSecurityModule(address)" | "setLiquidityLayerAdapter" | "setLiquidityLayerAdapter(string,address)" | "transferOwnership" | "transferOwnership(address)" | "unenrollRemoteRouter" | "unenrollRemoteRouter(uint32)" | "unenrollRemoteRouters" | "unenrollRemoteRouters(uint32[])"): FunctionFragment;
    encodeFunctionData(functionFragment: "dispatchWithTokens", values: [BigNumberish, BytesLike, string, BigNumberish, string, BytesLike]): string;
    encodeFunctionData(functionFragment: "dispatchWithTokens(uint32,bytes32,address,uint256,string,bytes)", values: [BigNumberish, BytesLike, string, BigNumberish, string, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "interchainSecurityModule()", values?: undefined): string;
    encodeFunctionData(functionFragment: "liquidityLayerAdapters", values: [string]): string;
    encodeFunctionData(functionFragment: "liquidityLayerAdapters(string)", values: [string]): string;
    ...
    encodeFunctionData(functionFragment: "setLiquidityLayerAdapter", values: [string, string]): string;
    encodeFunctionData(functionFragment: "setLiquidityLayerAdapter(string,address)", values: [string, string]): string;
    ...
    decodeFunctionResult(functionFragment: "dispatchWithTokens", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "dispatchWithTokens(uint32,bytes32,address,uint256,string,bytes)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "interchainSecurityModule()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "liquidityLayerAdapters", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "liquidityLayerAdapters(string)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setLiquidityLayerAdapter", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setLiquidityLayerAdapter(string,address)", data: BytesLike): Result;
    ...
    getEvent(nameOrSignatureOrTopic: "LiquidityLayerAdapterSet(string,address)"): EventFragment;
...
export type LiquidityLayerAdapterSetEventFilter = TypedEventFilter<LiquidityLayerAdapterSetEvent>;
...
export interface LiquidityLayerRouter extends BaseContract {
    ...
    functions: {
        dispatchWithTokens(_destinationDomain: BigNumberish, _recipientAddress: BytesLike, _token: string, _amount: BigNumberish, _bridge: string, _messageBody: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "dispatchWithTokens(uint32,bytes32,address,uint256,string,bytes)"(_destinationDomain: BigNumberish, _recipientAddress: BytesLike, _token: string, _amount: BigNumberish, _bridge: string, _messageBody: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "hook()"(overrides?: CallOverrides): Promise<[string]>;
        initialize(_interchainGasPaymaster: string, _interchainSecurityModule: string, _owner: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "initialize(address,address,address)"(_interchainGasPaymaster: string, _interchainSecurityModule: string, _owner: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        interchainSecurityModule(overrides?: CallOverrides): Promise<[string]>;
        "interchainSecurityModule()"(overrides?: CallOverrides): Promise<[string]>;
        liquidityLayerAdapters(arg0: string, overrides?: CallOverrides): Promise<[string]>;
        "liquidityLayerAdapters(string)"(arg0: string, overrides?: CallOverrides): Promise<[string]>;
        ...
        setLiquidityLayerAdapter(_bridge: string, _adapter: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "setLiquidityLayerAdapter(string,address)"(_bridge: string, _adapter: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        dispatchWithTokens(_destinationDomain: BigNumberish, _recipientAddress: BytesLike, _token: string, _amount: BigNumberish, _bridge: string, _messageBody: BytesLike, overrides?: CallOverrides): Promise<string>;
        "dispatchWithTokens(uint32,bytes32,address,uint256,string,bytes)"(_destinationDomain: BigNumberish, _recipientAddress: BytesLike, _token: string, _amount: BigNumberish, _bridge: string, _messageBody: BytesLike, overrides?: CallOverrides): Promise<string>;
        domains(overrides?: CallOverrides): Promise<number[]>;
        "domains()"(overrides?: CallOverrides): Promise<number[]>;
        ...
        hook(overrides?: CallOverrides): Promise<string>;
        "hook()"(overrides?: CallOverrides): Promise<string>;
        initialize(_interchainGasPaymaster: string, _interchainSecurityModule: string, _owner: string, overrides?: CallOverrides): Promise<void>;
        "initialize(address,address,address)"(_interchainGasPaymaster: string, _interchainSecurityModule: string, _owner: string, overrides?: CallOverrides): Promise<void>;
        interchainSecurityModule(overrides?: CallOverrides): Promise<string>;
        "interchainSecurityModule()"(overrides?: CallOverrides): Promise<string>;
        liquidityLayerAdapters(arg0: string, overrides?: CallOverrides): Promise<string>;
        "liquidityLayerAdapters(string)"(arg0: string, overrides?: CallOverrides): Promise<string>;
        ...
        setLiquidityLayerAdapter(_bridge: string, _adapter: string, overrides?: CallOverrides): Promise<void>;
        "setLiquidityLayerAdapter(string,address)"(_bridge: string, _adapter: string, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        "LiquidityLayerAdapterSet(string,address)"(bridge?: string | null, adapter?: null): LiquidityLayerAdapterSetEventFilter;
        LiquidityLayerAdapterSet(bridge?: string | null, adapter?: null): LiquidityLayerAdapterSetEventFilter;
    ...
    estimateGas: {
        ...
        "interchainSecurityModule()"(overrides?: CallOverrides): Promise<BigNumber>;
        liquidityLayerAdapters(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
        "liquidityLayerAdapters(string)"(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        "interchainSecurityModule()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        liquidityLayerAdapters(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "liquidityLayerAdapters(string)"(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=LiquidityLayerRouter.d.ts.map