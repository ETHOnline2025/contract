...
export interface PortalAdapterInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addDomain" | "addDomain(uint32,uint16)" | "completeTransfer" | "completeTransfer(bytes)" | "domains" | "domains()" | "enrollRemoteRouter" | "enrollRemoteRouter(uint32,bytes32)" | "enrollRemoteRouters" | "enrollRemoteRouters(uint32[],bytes32[])" | "handle" | "handle(uint32,bytes32,bytes)" | "hook" | "hook()" | "hyperlaneDomainToWormholeDomain" | "hyperlaneDomainToWormholeDomain(uint32)" | "initialize" | "initialize(address,address,address)" | "interchainSecurityModule" | "interchainSecurityModule()" | "liquidityLayerRouter" | "liquidityLayerRouter()" | "localDomain" | "localDomain()" | "mailbox" | "mailbox()" | "nonce" | "nonce()" | "owner" | "owner()" | "portalTokenBridge" | "portalTokenBridge()" | "portalTransfersProcessed" | "portalTransfersProcessed(bytes32)" | "receiveTokens" | "receiveTokens(uint32,address,uint256,bytes)" | "renounceOwnership" | "renounceOwnership()" | "routers" | "routers(uint32)" | "sendTokens" | "sendTokens(uint32,bytes32,address,uint256)" | "setHook" | "setHook(address)" | "setInterchainSecurityModule" | "setInterchainSecurityModule(address)" | "transferId" | "transferId(uint32,uint224)" | "transferOwnership" | "transferOwnership(address)" | "unenrollRemoteRouter" | "unenrollRemoteRouter(uint32)" | "unenrollRemoteRouters" | "unenrollRemoteRouters(uint32[])"): FunctionFragment;
    encodeFunctionData(functionFragment: "addDomain", values: [BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "addDomain(uint32,uint16)", values: [BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "completeTransfer", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "completeTransfer(bytes)", values: [BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "hook()", values?: undefined): string;
    encodeFunctionData(functionFragment: "hyperlaneDomainToWormholeDomain", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "hyperlaneDomainToWormholeDomain(uint32)", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "owner()", values?: undefined): string;
    encodeFunctionData(functionFragment: "portalTokenBridge", values?: undefined): string;
    encodeFunctionData(functionFragment: "portalTokenBridge()", values?: undefined): string;
    encodeFunctionData(functionFragment: "portalTransfersProcessed", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "portalTransfersProcessed(bytes32)", values: [BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "transferId", values: [BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "transferId(uint32,uint224)", values: [BigNumberish, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "addDomain(uint32,uint16)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "completeTransfer", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "completeTransfer(bytes)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "hook()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "hyperlaneDomainToWormholeDomain", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "hyperlaneDomainToWormholeDomain(uint32)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "owner()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "portalTokenBridge", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "portalTokenBridge()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "portalTransfersProcessed", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "portalTransfersProcessed(bytes32)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "transferId(uint32,uint224)", data: BytesLike): Result;
    ...
    getEvent(nameOrSignatureOrTopic: "BridgedToken(uint256,uint64,uint32)"): EventFragment;
...
export interface PortalAdapter extends BaseContract {
    ...
    functions: {
        addDomain(_hyperlaneDomain: BigNumberish, _wormholeDomain: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "addDomain(uint32,uint16)"(_hyperlaneDomain: BigNumberish, _wormholeDomain: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        completeTransfer(encodedVm: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "completeTransfer(bytes)"(encodedVm: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "hook()"(overrides?: CallOverrides): Promise<[string]>;
        hyperlaneDomainToWormholeDomain(arg0: BigNumberish, overrides?: CallOverrides): Promise<[number]>;
        "hyperlaneDomainToWormholeDomain(uint32)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<[number]>;
        initialize(_owner: string, _portalTokenBridge: string, _liquidityLayerRouter: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "initialize(address,address,address)"(_owner: string, _portalTokenBridge: string, _liquidityLayerRouter: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "portalTokenBridge()"(overrides?: CallOverrides): Promise<[string]>;
        portalTransfersProcessed(arg0: BytesLike, overrides?: CallOverrides): Promise<[string]>;
        "portalTransfersProcessed(bytes32)"(arg0: BytesLike, overrides?: CallOverrides): Promise<[string]>;
        ...
        transferId(_hyperlaneDomain: BigNumberish, _nonce: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
        "transferId(uint32,uint224)"(_hyperlaneDomain: BigNumberish, _nonce: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
    ...
    callStatic: {
        addDomain(_hyperlaneDomain: BigNumberish, _wormholeDomain: BigNumberish, overrides?: CallOverrides): Promise<void>;
        "addDomain(uint32,uint16)"(_hyperlaneDomain: BigNumberish, _wormholeDomain: BigNumberish, overrides?: CallOverrides): Promise<void>;
        completeTransfer(encodedVm: BytesLike, overrides?: CallOverrides): Promise<void>;
        "completeTransfer(bytes)"(encodedVm: BytesLike, overrides?: CallOverrides): Promise<void>;
        domains(overrides?: CallOverrides): Promise<number[]>;
        "domains()"(overrides?: CallOverrides): Promise<number[]>;
        ...
        hyperlaneDomainToWormholeDomain(arg0: BigNumberish, overrides?: CallOverrides): Promise<number>;
        "hyperlaneDomainToWormholeDomain(uint32)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<number>;
        initialize(_owner: string, _portalTokenBridge: string, _liquidityLayerRouter: string, overrides?: CallOverrides): Promise<void>;
        "initialize(address,address,address)"(_owner: string, _portalTokenBridge: string, _liquidityLayerRouter: string, overrides?: CallOverrides): Promise<void>;
        interchainSecurityModule(overrides?: CallOverrides): Promise<string>;
        "interchainSecurityModule()"(overrides?: CallOverrides): Promise<string>;
        liquidityLayerRouter(overrides?: CallOverrides): Promise<string>;
        "liquidityLayerRouter()"(overrides?: CallOverrides): Promise<string>;
    ...
    filters: {
        "BridgedToken(uint256,uint64,uint32)"(nonce?: null, portalSequence?: null, destination?: null): BridgedTokenEventFilter;
        BridgedToken(nonce?: null, portalSequence?: null, destination?: null): BridgedTokenEventFilter;
        "DomainAdded(uint32,uint32)"(hyperlaneDomain?: BigNumberish | null, wormholeDomain?: null): DomainAddedEventFilter;
        DomainAdded(hyperlaneDomain?: BigNumberish | null, wormholeDomain?: null): DomainAddedEventFilter;
    ...
    estimateGas: {
        ...
        "hook()"(overrides?: CallOverrides): Promise<BigNumber>;
        hyperlaneDomainToWormholeDomain(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "hyperlaneDomainToWormholeDomain(uint32)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        initialize(_owner: string, _portalTokenBridge: string, _liquidityLayerRouter: string, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        "initialize(address,address,address)"(_owner: string, _portalTokenBridge: string, _liquidityLayerRouter: string, overrides?: Overrides & {
        ...
        "portalTokenBridge()"(overrides?: CallOverrides): Promise<BigNumber>;
        portalTransfersProcessed(arg0: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        "portalTransfersProcessed(bytes32)"(arg0: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        receiveTokens(_originDomain: BigNumberish, _recipient: string, _amount: BigNumberish, _adapterData: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        "receiveTokens(uint32,address,uint256,bytes)"(_originDomain: BigNumberish, _recipient: string, _amount: BigNumberish, _adapterData: BytesLike, overrides?: Overrides & {
        ...
        transferId(_hyperlaneDomain: BigNumberish, _nonce: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "transferId(uint32,uint224)"(_hyperlaneDomain: BigNumberish, _nonce: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        transferOwnership(newOwner: string, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        "transferOwnership(address)"(newOwner: string, overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        "hook()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        hyperlaneDomainToWormholeDomain(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "hyperlaneDomainToWormholeDomain(uint32)"(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        initialize(_owner: string, _portalTokenBridge: string, _liquidityLayerRouter: string, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        "initialize(address,address,address)"(_owner: string, _portalTokenBridge: string, _liquidityLayerRouter: string, overrides?: Overrides & {
        ...
        "portalTokenBridge()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        portalTransfersProcessed(arg0: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "portalTransfersProcessed(bytes32)"(arg0: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        receiveTokens(_originDomain: BigNumberish, _recipient: string, _amount: BigNumberish, _adapterData: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        "receiveTokens(uint32,address,uint256,bytes)"(_originDomain: BigNumberish, _recipient: string, _amount: BigNumberish, _adapterData: BytesLike, overrides?: Overrides & {
        ...
        transferId(_hyperlaneDomain: BigNumberish, _nonce: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "transferId(uint32,uint224)"(_hyperlaneDomain: BigNumberish, _nonce: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        transferOwnership(newOwner: string, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        "transferOwnership(address)"(newOwner: string, overrides?: Overrides & {
...
//# sourceMappingURL=PortalAdapter.d.ts.map