...
export interface OwnableMulticallInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "multicall" | "multicall((bytes32,uint256,bytes)[])" | "owner" | "owner()"): FunctionFragment;
...
export interface OwnableMulticall extends BaseContract {
    ...
    functions: {
        multicall(calls: CallLib.CallStruct[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "multicall((bytes32,uint256,bytes)[])"(calls: CallLib.CallStruct[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
