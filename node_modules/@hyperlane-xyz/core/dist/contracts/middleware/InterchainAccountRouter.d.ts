...
export interface InterchainAccountRouterInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "accountOwners", values: [string]): string;
    encodeFunctionData(functionFragment: "accountOwners(address)", values: [string]): string;
    ...
    encodeFunctionData(functionFragment: "callRemote(uint32,address,uint256,bytes,bytes)", values: [BigNumberish, string, BigNumberish, BytesLike, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "owner()", values?: undefined): string;
    encodeFunctionData(functionFragment: "quoteGasPayment(uint32,bytes,uint256)", values: [BigNumberish, BytesLike, BigNumberish]): string;
    ...
    getEvent(nameOrSignatureOrTopic: "InterchainAccountCreated(uint32,bytes32,address,address)"): EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "RemoteCallDispatched(uint32,address,bytes32,bytes32)"): EventFragment;
...
export interface InterchainAccountRouter extends BaseContract {
    ...
    functions: {
        accountOwners(arg0: string, overrides?: CallOverrides): Promise<[number, string] & {
            origin: number;
            owner: string;
        }>;
        "accountOwners(address)"(arg0: string, overrides?: CallOverrides): Promise<[number, string] & {
            origin: number;
            owner: string;
        }>;
        "callRemote(uint32,address,uint256,bytes)"(_destination: BigNumberish, _to: string, _value: BigNumberish, _data: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        ...
        "callRemote(uint32,address,uint256,bytes,bytes)"(_destination: BigNumberish, _to: string, _value: BigNumberish, _data: BytesLike, _hookMetadata: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "owner()"(overrides?: CallOverrides): Promise<[string]>;
        "quoteGasPayment(uint32,bytes,uint256)"(_destination: BigNumberish, _messageBody: BytesLike, gasLimit: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber] & {
    ...
    callStatic: {
        ...
        "callRemote(uint32,address,uint256,bytes,bytes)"(_destination: BigNumberish, _to: string, _value: BigNumberish, _data: BytesLike, _hookMetadata: BytesLike, overrides?: CallOverrides): Promise<string>;
    ...
    estimateGas: {
        ...
        "accountOwners(address)"(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
        "callRemote(uint32,address,uint256,bytes)"(_destination: BigNumberish, _to: string, _value: BigNumberish, _data: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<BigNumber>;
        "callRemote(uint32,(bytes32,uint256,bytes)[],bytes)"(_destination: BigNumberish, _calls: CallLib.CallStruct[], _hookMetadata: BytesLike, overrides?: PayableOverrides & {
    ...
    populateTransaction: {
        accountOwners(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "accountOwners(address)"(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "callRemote(uint32,address,uint256,bytes)"(_destination: BigNumberish, _to: string, _value: BigNumberish, _data: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        ...
        "owner()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "quoteGasPayment(uint32,bytes,uint256)"(_destination: BigNumberish, _messageBody: BytesLike, gasLimit: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
